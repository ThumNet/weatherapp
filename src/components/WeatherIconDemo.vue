  ...
  <section
    ...
    :aria-label="
      languageStore.language === 'nl'
        ? 'Voorbeeld van weericonen (alleen dev)'
        : 'Weather icon showcase (dev only)'
    "
  >
    <!-- Header -->
    <div class="mb-4 flex items-center gap-2">
      <span
        class="rounded bg-amber-400 px-1.5 py-0.5 text-xs font-bold uppercase tracking-wide text-amber-900"
      >
        DEV
      </span>
      ...
      <div v-for="group in groups" :key="group.title">
        ...
        <div class="flex flex-wrap gap-3">
          ...
          >
            ...
            />
            <span
              class="max-w-[80px] text-center text-[10px] leading-tight text-slate-600 dark:text-slate-300"
            >
              {{ entry.label }}
            </span>
            <span
      ...
      <div>
        ...
        <div class="flex flex-wrap gap-3">
          ...
          >
            ...
            <span
              class="rounded-full bg-slate-200 px-1.5 py-0.5 text-[9px] font-medium text-slate-500 dark:bg-slate-700 dark:text-slate-400"
            >
